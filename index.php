        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                ...
                <ul class="navbar-nav" style="font-size: 20px;font-family: 'Roboto Condensed', sans-serif;">
                    ...
                    <li class="nav-item active">
                        <a class="p-2 text-secondary" href="pagesPrincipais/cursos.php">Cursos</a>
                    </li>

                    <li class="nav-item active">
                        <a class="p-2 text-secondary" href="pagesPrincipais/nucleos.php">Núcleos</a>
                    </li>

                    <li class="nav-item active">
                        <a class="p-2 text-secondary" href="pagesPrincipais/parceiros.php">Parceiros</a>
                    </li>

                    <li class="nav-item active">
                        <a class="p-2 text-secondary" href="pagesPrincipais/contato.php">Contato</a>
                    </li>
